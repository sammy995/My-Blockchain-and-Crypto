...
class Transaction:
    """
    Document exchange in currency from a sender to 1 or more recipients
    """
    ...
    def create_output(self, sender_wallet, recipient, amount):
        """
        Structure output data for transactions.
        """
    ...
    def create_input(self, sender_wallet, output):
        ...
        Sign the transation and include sender's public key and address
        """
        return{
    ...
    def update(self, sender_wallet,recipient, amount):
        """
        Updates the transaction with existing or new recipients
        """
    ...
    def from_json(transaction_json):
        """
        Deserialize a transaction's json representation into Transaction instance
        """
